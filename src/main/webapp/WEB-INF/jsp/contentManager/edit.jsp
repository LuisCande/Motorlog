...
<spring:message code="contentManager.name" var="nameMSG"/>
<spring:message code="contentManager.email" var="emailMSG"/>
<spring:message code="contentManager.identifier" var="identifierMSG"/>
<spring:message code="contentManager.phone" var="phoneMSG"/>
<spring:message code="contentManager.country" var="countryMSG"/>
<spring:message code="contentManager.city" var="cityMSG"/>
<spring:message code="contentManager.postalCode" var="postalCodeMSG"/>
<spring:message code="contentManager.address" var="addressMSG"/>
<spring:message code="contentManager.create.account" var="createContentManagerAccount"/>
...
<sec:authorize access="hasAuthority('CONTENTMANAGER')">
    <html>
    <head>
        <title><jstl:out value="${createContentManagerAccount}"/></title>
    </head>
    <body>
        ...
        <div class="col s12 m12">
            <div class="card amber lighten-5">
                <div class="card-content">
                    <h4><jstl:out value="${createContentManagerAccount}"/></h4>

                    <form:form action="${requestURI}" modelAttribute="contentManager">
                        ...
                        <div class="input-field col s6">
                            ...
                            <form:input path="phone" type ="text" class="validate" maxlength="200" placeholder="687122151" required="true" pattern="^[0-9-+s()]*$"/>
                        ...
                        <div class="input-field col s6">
                            ...
                            <form:input path="postalCode" type="text" class="validate" maxlength="200" required="true" pattern="^(?:0[1-9]|[1-4]\d|5[0-2])\d{3}$"/>
                        ...
                        <div class="input-field col s6">
                            ...
                            <form:input path="address" class="validate" maxlength="200" />
